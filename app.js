...
var _user$project$Main$ClickedOnReactButton = {ctor: 'ClickedOnReactButton'};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('React component'),
					_1: {
						ctor: '::',
						_0: A2(
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('Custom elment'),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$code,
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Elm view'),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Leaflet map'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A3(
								...
								{
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'center', '51.505,-0.09'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('A custom button'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A3(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ClickedOnReactButton),
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'label', 'yeah boii'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
...
var _user$project$Main$DomNoOp = {ctor: 'DomNoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"DomNoOp":[],"ClickedOnReactButton":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
